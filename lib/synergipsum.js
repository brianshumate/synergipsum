...
var adjectives = [ '24/7', '24/7/365', 'accurate', 'adaptive', 'agile',
    ...
    adverbs = [ 'appropriately', 'assertively', 'authoritatively',
                ...
                'uniquely' ],
    conjunctions = [ 'apropos', 'in lieu of', 'through', 'via', 'vis-a-vis',
                     'with', 'without', 'and', 'before', 'after', 'whereas',
                     'for', 'rather than' ],
    nouns = [ 'action items', 'aggregation engines', 'alignments',
    ...
    verbs = [ 'actualize', 'administrate', 'aggregate', 'architect',
