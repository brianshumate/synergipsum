var adjectives = new Array("24/7", "24/7/365", "accurate", "adaptive", "alternative", "an expanded array of", "B2B", "B2C", "backend", "backward-compatible", "best-of-breed", "bleeding-edge", "bricks-and-clicks", "business", "clicks-and-mortar", "client-based", "client-centered", "client-centric", "client-focused", "collaborative", "compelling", "competitive", "cooperative", "corporate", "cost effective", "covalent", "cross functional", "cross-media", "cross-platform", "cross-unit", "customer directed", "customized", "cutting-edge", "distinctive", "distributed", "diverse", "dynamic", "e-business", "economically sound", "effective", "efficient", "emerging", "empowered", "enabled", "end-to-end", "enterprise", "enterprise-wide", "epic", "equity invested", "error-free", "ethical", "excellent", "exceptional", "extensible", "extensive", "flexible", "focused", "frictionless", "front-end", "fully researched", "fully tested", "functional", "functionalized", "future-proof", "global", "go forward", "geocentric", "geofenced", "geo-social",  "goal-oriented", "granular", "high standards in", "high-payoff", "high-quality", "highly efficient", "HTML5", "holistic", "impactful", "inexpensive", "innovative", "installed base", "integrated", "interactive", "interdependent", "intermandated", "interoperable", "intuitive", "just in time", "kinda",  "leading-edge", "leveraged", "long-term high-impact", "low-risk high-yield", "magnetic", "maintainable", "market positioning", "market-driven", "mission-critical", "multidisciplinary", "multifunctional", "multimedia based", "next-generation", "object oriented", "one-to-one", "open-source", "optimal", "orthogonal", "out-of-the-box", "pandemic", "parallel", "performance based", "pivotal", "plug-and-play", "premier", "premium", "principle-centered", "proactive", "process-centric", "professional", "progressive", "prospective", "quality", "real-time", "reliable", "resource sucking", "resource maximizing", "resource-leveling", "revolutionary", "robust", "scalable", "seamless", "social", "social-aware", "sorta", "stand-alone", "standardized", "standards compliant", "state of the art", "sticky", "strategic", "superior", "sustainable", "synergistic", "tactical", "team building", "team driven", "technically sound", "timely", "top-line", "transparent", "turnkey", "ubiquitous", "unique", "user-centric", "user friendly", "value-added", "vertical", "viral", "virtual", "visionary", "web-enabled", "wireless", "world-class", "worldwide", "2.0", "3.0"),
    ...
    nouns = new Array("action items", "alignments", "Android apps", "applications", "app stores", "architectures", "bandwidth", "benefits", "best practices", "blockers", "blog posts", "brogrammers", "catalysts for change", "channels", "cloud services", "collaboration and idea-sharing", "communities", "content", "convergence", "core competencies", "customer service", "DSLs", "data", "deliverables", "devops teams", "e-business", "e-commerce", "e-markets", "e-tailers", "e-services", "event loops", "experiences", "expertise", "functionalities", "gists", "git repositories", "growth strategies", "Haskell developers", "human capital", "ideas", "imperatives", "impetus",  "infomediaries", "information", "infrastructures", "initiatives", "innovation", "intellectual capital", "interfaces", "internal or \'organic\' sources", "JavaScript developers", "leadership", "MongoDB clusters", "leadership skills", "manufactured products", "markets", "materials", "meta-services", "methodologies", "methods of empowerment", "metrics", "mindshare", "mobile", "mobile apps", "models", "networks", "niches", "niche markets", "Node.JS developers", "NoSQL", "offshoring", "opportunities", "\'outside the box\' thinking", "outsourcing", "paradigms", "partnerships", "platforms", "podcasts", "portals", "potentialities", "process improvements", "processes", "programmers", "products", "quality vectors", "relationships", "resources", "results", "Riak clusters", "ROI", "Ruby apps", "Ruby on Rails apps", "scenarios", "schemas", "services", "solutions", "sources", "strategic theme areas", "supply chains", "synergy", "systems", "system logs", "technologies", "technology", "testing procedures", "the cloud", "thought leaders", "total linkage", "users", "value", "web-readiness", "web scale", "web services", "web caching engines", "WebOS apps"),
